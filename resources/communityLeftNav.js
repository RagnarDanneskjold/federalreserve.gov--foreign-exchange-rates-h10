...
linx["Conferences & Convenings"] = "$/newsevents/conferences/conferences.htm#14909";
linx["Research Publications & Data Analysis"] = "$/communitydev/community-development-publications.htm";
linx["Community Development Topics"] = "%FIRSTLEVELHEADING";
linx["Housing &amp; Neighborhood Revitalization"] = "/communitydev/neighborhood-revitalization.htm";
linx["Small Business &amp; Entrepreneurship"] = "/communitydev/small-business-and-entrepreneurship.htm";
linx["Employment and Workforce Development"] = "/communitydev/workforce.htm";
linx["Community Development Finance"] = "/communitydev/cdf.htm";
linx["Federal Reserve System Resources"] = "$/communitydev/comm-dev-system-map.htm";
linx["Financial Experiences of Older Adults"] = "$/communitydev/older-adults.htm";
linx["Mobile Financial Services"] = "$/communitydev/mobile_finance.htm";
linx["Home Ownership and Equity Protection Act (HOEPA)"] = "$/communitydev/hoepahearingtranscripts.htm";
linx["Home Mortgage Disclosure Act"] = "$/communitydev/hmda.htm";
linx["Household Economics and Decisionmaking"] = "$/communitydev/shed.htm";
