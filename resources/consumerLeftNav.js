...
var linx = new Object();
linx["5 Tips Series"] = "$/consumerinfo/fivetips.htm";
linx["Bank Accounts and Services"] = "$/consumerinfo/bankaccountservices.htm";
linx["Credit Reports and Credit Scores"] = "$/creditreports/default.htm";
linx["Identity Theft"] = "$/consumerinfo/idtheft.htm";
linx["Frauds and Scams"] = "$/consumerinfo/fraudsAndScams.htm";
linx["Leasing"] = "$/consumerinfo/leasing.htm";
linx["Mortgages and Foreclosures"] = "$/consumerinfo/foreclosure.htm";
linx["Personal Finance"] = "$/consumerinfo/personalfinance.htm";
linx["Federal Agency Contacts"] = "$/consumerinfo/agency.htm";
linx["Independent Foreclosure Review"] = "$/consumerinfo/independent-foreclosure-review.htm";
